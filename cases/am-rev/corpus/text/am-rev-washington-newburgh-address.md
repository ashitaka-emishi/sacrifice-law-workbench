---
document_id: am-rev-washington-newburgh-address
title: Address to the Officers of the Army
short_title: Newburgh Address
date: '1783-03-15'
date_precision: day
register: military-political address
authorship: George Washington
source_url: https://founders.archives.gov/documents/Washington/99-01-02-10840
source_citation: Washington, George. Address to the Officers of the Army, 15 March
  1783. Founders Online, National Archives.
rights_status: public-domain
expected_raw_path: corpus/raw/am-rev-src-05-washington-newburgh.txt
analytical_priority: primary
source_registry_id: am-rev-src-05-washington-newburgh
phase: wartime-sacrifice
inclusion_rationale: Adds Newburgh crisis evidence for army sacrifice, public debt,
  honor, civil-military restraint, and rejection of military coercion after service.
risk_flags:
...
case_id: am-rev
raw_path: corpus/raw/am-rev-src-05-washington-newburgh.txt
pipeline_log:
...
In the moment of this summons, another anonymous production was sent into circulation; addressed more to the feelings & passions, than to the reason & judgment of the Army.
...
or--in this state of hostile seperation, are we to take the two first (the latter cannot be removed) to perish in a Wilderness, with hunger cold & nakedness? If Peace takes place, never sheath your Sword says he untill you have obtained full and ample Justice--this dreadful alternative, of either deserting our Country in the extremest hour of her distress, or turning our Army against it, (which is the apparent object, unless Congress can be compelled into an instant compliance) has something so shocking in it, that humanity revolts at the idea.
...
Why then should we distrust them? and, in consequence of that distrust, adopt measures, which may cast a shade over that glory which, has been so justly acquired; and tarnish the reputation of an Army which is celebrated thro' all Europe, for its fortitude and Patriotism? and for what is this done? to bring the object we seek for nearer? No! most certainly, in my opinion, it will cast it at a greater distance.
...
By thus determining--& thus acting, you will pursue the plain & direct Road to the attainment of your wishes. You will defeat the insidious designs of our Enemies, who are compelled to resort from open force to secret Artifice.
