...
short_title: First Inaugural
date: '1861-03-04'
date_precision: day
register: inaugural-address
authorship: Abraham Lincoln
source_url: https://www.gutenberg.org/ebooks/9
source_citation: 'Lincoln, Abraham. Abraham Lincoln''s First Inaugural Address. Project
  Gutenberg EBook #9.'
rights_status: public-domain
expected_raw_path: corpus/raw/lincoln-src-04-first-inaugural.txt
...
verification:
  ...
  - mystic chords
source_registry_id: lincoln-src-04-first-inaugural
period: secession-crisis
phase: secession-crisis
genre: inaugural address
source_edition: 'Project Gutenberg EBook #9, standalone First Inaugural transcription'
...
inclusion_rationale: Adds immediate secession-crisis evidence for Union, constitutional
  oath, force limits, federal property, minority rule, and sacred civic bonds before
...
known_limitations: Public-domain transcription is adequate for draft annotation; exact
  wording should be cross-checked against LOC or Collected Works before publication-level
  quotation.
case_id: lincoln
raw_path: corpus/raw/lincoln-src-04-first-inaugural.txt
pipeline_log:
