...
| --- | --- | --- |
| sacred_object | 2.4 | moderate support |
| sacrificial_body | 2.4 | moderate support |
| enemy_as_bringer_of_death | 1.0 | weak support |
| historical_enactment_alignment | 2.6 | strong support |

Weighted shifted geometric score: `2.13`.

Historical-alignment cap applied. Overall category: **moderate support**.
